...
const Profile = ({ user, logOut }) => {
  ...
  return (
    <div
      className="ml-4 relative profile hidden md:block"
    ...
    >
      ...
      {/* Dropdown */}
      <div
        className={`absolute right-0 mt-2 max-w-xs min-w-[200px] bg-white shadow-lg origin-top-right transition-all duration-300 ease-in-out ${
